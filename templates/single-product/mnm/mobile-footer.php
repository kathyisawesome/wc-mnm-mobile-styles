        ...
        if ( $container->is_purchasable() ) { ?>
            ...
            <div class="column col-2">
                ...
                <div class="mnm_button_wrap">
                    ...
                    <button name="add-to-cart" value="<?php echo esc_attr( $container->get_id() ); ?>" data-product_id="<?php echo esc_attr( $container->get_id() ); ?>" class="single_add_to_cart_button mnm_add_to_cart_button button alt"><?php echo $container->single_add_to_cart_text(); ?></button>
